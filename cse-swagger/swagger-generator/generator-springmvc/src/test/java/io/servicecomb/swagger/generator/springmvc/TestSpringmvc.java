...
public class TestSpringmvc {
    ...
    public void testMethodMultiHttpMethod() throws Exception {
        UnitTestSwaggerUtils.testException(
                "not allowed multi http method for Echo:multiHttpMethod",
                context,
                Echo.class,
                "multiHttpMethod");
    }
    ...
    public void testClassMultiHttpMethod() throws Exception {
        UnitTestSwaggerUtils.testException(
                "not allowed multi http method for ClassMultiHttpMethod",
                context,
    ...
    public void testMethodMultiPath() throws Exception {
        UnitTestSwaggerUtils.testException(
                "not allowed multi path for Echo:multiPath",
                context,
                Echo.class,
                "multiPath");
    }
    ...
    public void testClassMultiPath() throws Exception {
        UnitTestSwaggerUtils.testException(
                "not support multi path for ClassMultiPath",
                context,
