...
public class YAMLConfigurationSource implements PolledConfigurationSource {
     ...
     * <p>
     * <ul>
     * <li>A configuration file (default name to be <code>io.servicecomb.config.archaius.sources.io.servicecomb.
     * .config.properties</code>, see {@link #DEFAULT_CONFIG_FILE_NAME}) on the classpath
